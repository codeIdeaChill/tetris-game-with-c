...
var ASM_CONSTS = {
  103272: () => { if (document.fullscreenElement) return 1; },  
 103318: () => { return document.getElementById('canvas').width; },  
 103370: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103438: () => { document.exitFullscreen(); },  
 103465: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 103538: () => { if (document.fullscreenElement) return 1; },  
 103584: () => { return document.getElementById('canvas').width; },  
 103636: () => { return screen.width; },  
 103661: () => { document.exitFullscreen(); },  
 103688: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 103821: () => { return window.innerWidth; },  
 103847: () => { return window.innerHeight; },  
 103874: () => { if (document.fullscreenElement) return 1; },  
 103920: () => { return document.getElementById('canvas').width; },  
 103972: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104040: () => { if (document.fullscreenElement) return 1; },  
 104086: () => { return document.getElementById('canvas').width; },  
 104138: () => { return screen.width; },  
 104163: () => { return window.innerWidth; },  
 104189: () => { return window.innerHeight; },  
 104216: () => { if (document.fullscreenElement) return 1; },  
 104262: () => { return document.getElementById('canvas').width; },  
 104314: () => { return screen.width; },  
 104339: () => { document.exitFullscreen(); },  
 104366: () => { if (document.fullscreenElement) return 1; },  
 104412: () => { return document.getElementById('canvas').width; },  
 104464: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104532: () => { document.exitFullscreen(); },  
 104559: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 104617: () => { return screen.width; },  
 104642: () => { return screen.height; },  
 104668: () => { return window.screenX; },  
 104695: () => { return window.screenY; },  
 104722: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 104775: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 104846: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 104903: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 105159: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 105230: () => { if (document.fullscreenElement) return 1; },  
 105276: () => { return window.innerWidth; },  
 105302: () => { return window.innerHeight; },  
 105329: () => { if (document.pointerLockElement) return 1; }
};
